...
Title:
Migrate Target -> Targets in AttackBehaviors\HeroAttackBehavior.cs
...
- Do not touch any other file, including `Actions\AttackAction.cs` (MECH-006) or `AttackBehaviors\MinionAttackBehavior.cs` (MECH-012).
