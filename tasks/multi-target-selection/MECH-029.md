...
Title:
Migrate Target -> Targets in CardBattleEngine.Test\DiscoverTests.cs
...
Files:
CardBattleEngine.Test\DiscoverTests.cs
...
- Note: `Choice\DiscoverChoice.cs` and `Choice\DiscoverActionFactory.cs` are NOT test files and are out of scope here (`DiscoverActionFactory.cs` is handled separately by MECH-013).
