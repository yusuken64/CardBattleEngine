...
Title:
Migrate Target -> Targets in CardBattleEngine.Test\SpellTest.cs
...
Files:
CardBattleEngine.Test\SpellTest.cs
...
- Do not add a multi-target ("pick 2, swap health") test here — that belongs to a separate later task (POC-002).
