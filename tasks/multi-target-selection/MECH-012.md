...
Title:
Migrate Target -> Targets in AttackBehaviors\MinionAttackBehavior.cs
...
- Do not touch any other file, including `Actions\AttackAction.cs` (MECH-006) or `AttackBehaviors\HeroAttackBehavior.cs` (MECH-011).
