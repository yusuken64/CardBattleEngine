...
Title:
Migrate Target -> Targets in Choice\DiscoverActionFactory.cs
...
Files:
CardBattleEngine\Choice\DiscoverActionFactory.cs
...
- Do not change any behavior other than the field rename. This file is unrelated to the new `MultiTargetChoice` type introduced in Phase B (MTC-002) — do not add anything related to that here.
