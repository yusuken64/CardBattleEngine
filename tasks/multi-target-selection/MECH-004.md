...
Title:
Migrate Target -> Targets in Actions\AddKeywordAction.cs (class ChangeKeywordAction)
...
Files:
CardBattleEngine\Actions\AddKeywordAction.cs

Requirements:
Apply these substitution rules to every occurrence of `.Target` (singular) in this file (the relevant class here is named `ChangeKeywordAction`):
